...
const items = [
  ...
  },
  {
    ...
    a: "Es müssen mindestens 3 Tage ausgewählt werden. Je mehr Tage du auswählst, desto höher ist die Wahrscheinlichkeit und desto schneller finden wir einen Termin. Für den frühestmöglichen Termin empfehlen wir alle verfügbaren Tage anzuhaken – das System bucht dann den ersten freien Slot.",
  },
  {
